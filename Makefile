...
all:
	...
	GOOS=windows GOARCH=amd64 go build -o swipe-go.exe
	zip swipe-go-win64.zip swipe-go.exe
	GOOS=linux GOARCH=386 go build -o swipe-go.exe
	zip swipe-go-linux32.zip swipe-go.exe
	GOOS=windows GOARCH=amd64 go build -o swipe-go.exe
	zip swipe-go-linux64.zip swipe-go.exe
	GOOS=darwin GOARCH=386 go build -o swipe-go.exe
	zip swipe-go-mac32.zip swipe-go.exe
	GOOS=darwin GOARCH=amd64 go build -o swipe-go.exe
